    ...
    <nav id="main">
        <div id="a1">
          <!-- external content -->
           ...
           <div id="ad" ></div><a href="/admin_login.jsp" id="admin"> <h4>ADMIN</h4></a></div>
                <%}else{ %>
                <div id="ad" ></div><a href="/logout" id="admin"> <h4>Logout</h4></a></div>
                <%} %>
            </div>   
    </nav>
      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            ...
            <img src="../photos/waterfall.gif" class="d-block w-100" alt="..." height="100%" id="first">
            <div class="carousel-caption d-none d-md-block">
              <center><button type="button" class="btn btn-warning"><a href="/Packages.jsp" id="discover">Discover More</a></button></center>
          ...
          <div class="carousel-item">
            <img src="../photos/girl.gif" class="d-block w-100" alt="..." height="100%" id="sec">
            <div class="carousel-caption d-none d-md-block">
              <center><button type="button" class="btn btn-warning"> <a href="/Packages.jsp" id="discover">Discover More</a></button></center>
          ...
          <div class="carousel-item">
            <img src="../photos/fam.gif" class="d-block w-100" alt="..." height="100%" id="third">
            <div class="carousel-caption d-none d-md-block">
              <center><button type="button" class="btn btn-warning"><a href="/Packages.jsp" id="discover">Discover More</a></button></center>
    ...
    <footer class="footer">
        <div class="footer-cols">
          ...
          <!-- <ul type="none"> -->
           ...
           <div><img src="../photos/fb.png" alt=""  height="50px"></div>
           <div><img src="../photos/insta.png" alt="" height="50px"></div>
           <div><img src="../photos/tweeter.png" alt="" height="50px"></div>
           <div><img src="../photos/linkedin.png" alt="" height="50px"></div>
